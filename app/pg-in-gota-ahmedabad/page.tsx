  ...
  return (
    <>
      ...
      <LocalSeoLandingPage
        ...
        audienceCta="Best for students and working residents in Gota - single sharing from INR 16,500/month and double sharing from INR 14,500/month all-inclusive (subject to availability)."
        landmarks={[
