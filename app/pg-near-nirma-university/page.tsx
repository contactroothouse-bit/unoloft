  ...
  return (
    <>
      ...
      <LocalSeoLandingPage
        ...
        audienceCta="Perfect for Nirma students - double sharing from INR 14,500/month all-inclusive and single sharing from INR 16,500/month (subject to availability)."
        landmarks={[
